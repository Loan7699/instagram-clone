...
function DetailUser() {
    ...
    return (
        <div>
            <Header />
            <div className="mt-16 bg-[#FAFAFA] md:px-5 md:pt-7 max-width mx-auto overflow-hidden">
                <div className="flex mx-4 pt-6 mb-6">
                    <div className="mr-7 basis-0 grow">
                        <div className='w-20 h-20 md:w-36 md:h-36 mx-auto'>
                            <img className="rounded-full border border-solid border-#DBDBDB" src={`/homepage/${id}.jpg`} />
                    ...
                    <div className='flex-profile'>
                        <div className='md:flex md:mb-2'>
                            <div className='flex'>
                                ...
                                {profile[0] &&
                                    <p className='text-[28px] font-extralight'>{profile[0].accountName}</p>
                                }
                ...
                <div className="px-4 pb-[21px] text-left md:hidden">
                    {profile[0] &&
                        <span className='text-sm font-bold'>{profile[0].name}</span>
                    }
                </div>
                ...
                <div className='flex justify-around md:justify-center h-14 items-center md:border-t md:border-solid md:border-[#DBDBDB]'>
                    ...
                    <a href="" className='flex mr-16'>
                        ...
                        <div className='uppercase hidden md:block text-[#8E8E8E] ml-1.5 text-xs font-semibold'>reels</div>
                    </a>
                ...
                <div className='flex flex-col'>
                    <div className='flex md:mb-7 mb-1'>
                        <div classname="w-full shrink-0 grow basis-0">
                            ...
                            <a href='' className='cursor-pointer'>
                                <div className='mr-[3px] md:mr-7 overflow-hidden max-img'>
                                    <img src={`/detailUser/${id}/1.jpg`} className='object-cover w-full h-full' />
                                </div>
                            </a>
                        </div>
                        <div classname="w-full shrink-0 grow basis-0">
                            <a href='' className='relative cursor-pointer'>
                                <div className='mr-[3px] md:mr-7 overflow-hidden max-img'>
                                    ...
                                    <img src={`/detailUser/${id}/2.jpg`} className='object-cover w-full h-full' />
                        ...
                        <div classname="w-full shrink-0 grow basis-0">
                            <a href='' className='cursor-pointer'>
                                <div className='overflow-hidden max-img'>
                                    <img src={`/detailUser/${id}/3.jpg`} className='object-cover w-full h-full' />
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className='flex'>
                        <div classname="">
                            <a href=''>
                                <div className='md:mr-7 mr-[3px] max-img'>
                                    <img src={`/detailUser/${id}/4.jpg`} className='object-cover w-full h-full' />
                                </div>
                        ...
                        <div classname="">
                            <a href=''>
                                <div className='mr-[3px] md:mr-7 max-img'>
                                    <img src={`/detailUser/${id}/5.jpg`} className='object-cover w-full h-full' />
                                </div>
                            </a>
                        </div>
                        <div relative>
                            <a href=''>
                                <div className='max-img'>
                                    <img src={`/detailUser/${id}/6.jpg`} className='object-cover w-full h-full' />
                                </div>
                                <BiMerge className='text-[#FFFFFF] relative top-2 right-2' />
                            </a>
                        </div>
